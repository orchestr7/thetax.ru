(function (_, kotlin_kotlin) {
  ...
  protoOf(AtomicRef).j8 = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).k8 = function () {
  ...
  protoOf(AtomicBoolean).l8 = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).k8 = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).m8 = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).k8 = function () {
    return this.kotlinx$atomicfu$value;
  };
